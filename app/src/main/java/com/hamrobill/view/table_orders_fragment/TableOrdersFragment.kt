...
import com.hamrobill.databinding.FragmentActiveTableOrdersBinding
...
class TableOrdersFragment : BottomSheetDialogFragment(), View.OnClickListener {
    ...
    private lateinit var mBinding: FragmentActiveTableOrdersBinding
    ...
    override fun onCreateView(
        ...
        mBinding = FragmentActiveTableOrdersBinding.inflate(inflater)
        mViewModel =
    ...
    private fun initializeViews() {
        ...
        mBinding.tableName.text = mViewModel.selectedTable.value!!.tableName
